...
- **"Service"** – The ELIPHASx jewelry manufacturing quote management software
- **"User"** – Any individual accessing the Service
- **"Subscriber"** – An organization with an active subscription
- **"Content"** – Data, quotes, client information entered into the Service
...
ELIPHASx provides:
- Jewelry quote creation and management
- Client relationship management
- Metal and stone pricing calculations
...
- One person must be designated as the Organization Owner
- The Owner is responsible for all users within the organization
...
### 5.1 Plans
| Plan | Price (ZAR) | Billing |
|------|-------------|---------|
| Professional | R1,499/month | Monthly or Annual |
| Business | R2,999/month | Monthly or Annual |
| Enterprise | R5,999/month | Monthly or Annual |

### 5.2 Billing
- Payments processed via Paystack in South African Rand (ZAR)
- Subscriptions renew automatically unless cancelled
- Annual plans billed upfront with 17% discount

### 5.3 Price Changes
We may adjust prices with 30 days' notice. Current subscriptions are honored until renewal.
...
### 7.1 Cancellation
- Cancel anytime via the Billing page
...
|----------|--------------|
| Monthly plan | No refunds (cancel for next month) |
| Annual plan (first 14 days) | Full refund |
| Annual plan (after 14 days) | Pro-rata refund minus 2 months |
...
### 11.1 Uptime
We target 99.5% uptime. Scheduled maintenance will be announced in advance.

### 11.2 No Guarantee
The Service is provided "as is". We do not guarantee uninterrupted access.
...
**By using ELIPHASx, you acknowledge that you have read, understood, and agree to these Terms of Service.**
